...
public class ArcadeDriveCommand extends Command {
	...
	private Drivetrain m_drivetrain; // Use member variable naming convention next year
	private Joystick m_joystick; // Use member variable naming convention next year
